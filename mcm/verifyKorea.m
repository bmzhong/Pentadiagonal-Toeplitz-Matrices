%获得韩国每个阶段的P1 P2 lamda1 lamda2 i u0 以及获得验证的确诊人数
clc;clear;
[d,r,Itrue]=KoreaData();%获取韩国的数据
%第一阶段
start1=1;
finish1=22;
n=start1-finish1;
...
lb=zeros(1,6);
ub=[1,1,1,1,1,1000000];
x0=[0.7,0.955,0.36,0.80,0.44,1200];
...
lb=zeros(1,6);
ub=[1,1,1,1,1,1000000];
x0=[0.54,0.41,0.79,0.90,0.88,2250];
